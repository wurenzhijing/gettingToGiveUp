 ...
 */
public class InstanceActivity2 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bt_Instance1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InstanceActivity2.this, InstanceActivity1.class);
                startActivity(intent);
                tv_Instance.setText(InstanceActivity2.this.toString());
            }
        });
        ...
        bt_SingleInstanceActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InstanceActivity2.this, SingleInstanceActivity.class);
                startActivity(intent);
        ...
        bt_Instance2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InstanceActivity2.this, InstanceActivity2.class);
                startActivity(intent);
            }
        });
    }
