    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        bt_task1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TaskActivity1.this,TaskActivity1.class);
                startActivity(intent);
                tv_task.setText(TaskActivity1.this.toString());
            }
        });
        ...
        bt_SingleTaskActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TaskActivity1.this,SingleTaskActivity.class);
                startActivity(intent);
        ...
        bt_task2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TaskActivity1.this,TaskActivity2.class);
                startActivity(intent);
            }
        });
    }
